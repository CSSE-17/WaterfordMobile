...
public class InventoryEntity {
    ...
    public InventoryEntity(String Item, String name, String descript, int quant, String rcvfrm, String rcvdate, String exrdate, Double unit_price, int min_level) {
        this.Item_code = Item;
        this.Item_name = name;
    ...
    public void addNewInventory(InventoryEntity inventory) {
